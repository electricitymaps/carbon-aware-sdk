...
data, including WattTime, Electricity Maps (with a free or paid account), and a custom
...
| Type                          | WattTime  | Electricity Maps                                                                   | Electricity Maps (free account) | JSON     |
|-------------------------------|-----------|------------------------------------------------------------------------------------|---------------------|----------|
...
| Methods                 | WattTime | Electricity Maps | Electricity Maps (free account) |   JSON   | CLI Usage                                                              | Web Api Usage                                                                                                                                                                                           | SDK Usage                                                                                                     |
| ----------------------- | :------: | :-------------: | :-----------------: | :------: | :--------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------------------------------: |
...
- For `WattTime`, see their
  ...
  relevant zone.
- For `Electricity Maps`, see their
  [live map app](https://app.electricitymaps.com/map)
  to find the relevant zone and see current data coming in, or the [zone endpoint](https://api.electricitymap.org/v3/zones).

## Restrictions: Electricity Maps free account

Electricity Maps free accounts can be created on [ElectricityMaps API Portal](https://portal.electricitymaps.com/auth/login?utm_source=carbon-aware-sdk). Free tier users only have access to two endpoints in the Electricity Maps API, of which only the following is currently supported as part of Carbon Aware SDK:
